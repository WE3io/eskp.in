...
|------|--------|-------|-----------|--------|--------|
| Anthropic API tokens | $30 | $3.1553 | $26.8447 | 10.52% | ✅ OK |
| **Total** | **$30** | **$3.1553** | **$26.8447** | **10.52%** | **✅ OK** |

### Usage detail (from local token_usage table)
```
  anthropic/claude-4.5-haiku-20251001 [openrouter]: 93 calls, 765,816 in / 24,589 out = $0.8888
  anthropic/claude-opus-4-6 [openrouter]: 3 calls, 45,000 in / 9,000 out = $1.3500
  anthropic/claude-sonnet-4-6 [openrouter]: 5 calls, 175,000 in / 25,000 out = $0.9000
...
### Month progress
Day 14 of ~31 (~45% of month elapsed)
...
- Operational costs (est.): £6.48 GBP (infra £4.00 + API £2.48)
...
|-------|--------|-------|---------|-----|
| March 2026 | $30 | $3.1553 | £0.00 GBP | -$3.1553 |


---

*Last updated: 2026-03-14T12:17:32.276Z*
