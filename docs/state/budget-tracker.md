...
|------|--------|-------|-----------|--------|--------|
| Anthropic API tokens | $30 | $5.3745 | $24.6255 | 17.92% | ✅ OK |
| **Total** | **$30** | **$5.3745** | **$24.6255** | **17.92%** | **✅ OK** |
...
```
  ...
  anthropic/claude-opus-4-6 [openrouter]: 4 calls, 60,000 in / 12,000 out = $1.8000
  anthropic/claude-sonnet-4-6 [openrouter]: 12 calls, 420,000 in / 60,000 out = $2.1600
...
### Month progress
Day 15 of ~31 (~48% of month elapsed)
...
- Operational costs (est.): £8.23 GBP (infra £4.00 + API £4.23)
...
|-------|--------|-------|---------|-----|
| March 2026 | $30 | $5.3745 | £0.00 GBP | -$5.3745 |


---

*Last updated: 2026-03-15T20:00:01.434Z*
